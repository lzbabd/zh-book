  ...
  <div class="store">
    ...
    <section class="store-middle">
      ...
      <section class="store-compile store_common">
        ...
        <router-link tag="section" :to="`/details/${book._id}`" v-for="(book,index) in recommend" class="compile_list">
      ...
      <section class="store-time store_common">
        ...
        <router-link tag="section" :to="`/details/${book._id}`" v-for="(book,index) in free" class="compile_list" :key="index">
          <section class="compile_list_left">
            <img v-lazy="'http://statics.zhuishushenqi.com'+book.cover" alt="">
          </section>
          <div class="compile_list_right">
      ...
      <section class="store_boom">
        ...
        <ul  class="boom_list">
          <router-link tag="li" :to="`/details/${book._id}`" v-for="(book,index) in sell" :key="index"><img v-lazy="'http://statics.zhuishushenqi.com'+book.cover" alt="">
      ...
      <section class="store_man store_common">
        ...
        <router-link tag="section" :to="`/details/${book._id}`" v-for="(book,index) in recommend" :key="index" class="compile_list">
          <section class="compile_list_left">
            <img v-lazy="'http://statics.zhuishushenqi.com'+book.cover" alt="">
          </section>
          <div class="compile_list_right">
      ...
      <section class="store_woman store_common">
        ...
        <router-link tag="section" :to="`/details/${book._id}`" v-for="(book,index) in female" :key="index" class="compile_list">
          <section class="compile_list_left">
            <img v-lazy="'http://statics.zhuishushenqi.com'+book.cover" alt="">
          </section>
          <div class="compile_list_right">
      ...
      <section class="store_boom store_bottom">
        ...
        <ul  class="boom_list">
          <router-link tag="li" :to="`/details/${book._id}`" v-for="(book,index) in newBook" :key="index"><img v-lazy="'http://statics.zhuishushenqi.com'+book.cover" alt="">
            <span>{{book.author}}</span>
          </router-link>
        </ul>
      </section>
