  ...
  <div class="store">
    ...
    <section class="store-middle">
      ...
      <section class="store_boom">
        ...
        <ul class="boom_list">
          <router-link tag="li" :to="`/details/${book._id}`" v-for="book in sell"><img
            v-lazy="'http://statics.zhuishushenqi.com'+book.cover" alt="">
      ...
      <section class="store_boom store_bottom">
        ...
        <ul class="boom_list">
          <router-link tag="li" :to="`/details/${book._id}`" v-for="book in newBook"><img
            v-lazy="'http://statics.zhuishushenqi.com'+book.cover" alt="">
            <span>{{book.author}}</span>
          </router-link>
        </ul>
